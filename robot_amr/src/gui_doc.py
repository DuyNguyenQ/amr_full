...
client.write_registers(0x2E, 10, unit= 0x01)
client.write_register(0x2F, 10, unit= 0x01)
client.write_register(0x30,0, unit=0x01)
client.write_register(0x7C, 0x96, unit= 0x01)

client.write_register(0x7C, 0xD8, unit= 0x02)
client.write_registers(0x2E, 10, unit= 0x02)
client.write_register(0x2F, 10, unit= 0x02)
...
def xu_li():     
    rospy.init_node('gui_doc', anonymous=True)
    rate = rospy.Rate(30)
